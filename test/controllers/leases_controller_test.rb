...
class LeasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lease" do
    assert_difference('Lease.count') do
      post leases_url, params: { lease: { adviser_id: @lease.adviser_id, cant: @lease.cant, name: @lease.name } }
    end
  ...
  test "should update lease" do
    patch lease_url(@lease), params: { lease: { adviser_id: @lease.adviser_id, cant: @lease.cant, name: @lease.name } }
